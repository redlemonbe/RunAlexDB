...
impl FirewallManager {
    ...
    pub fn new(manage: bool, backend_override: Option<&str>, tag: &str) -> Self {
        let dry_run = std::env::var("RUNALEXDB_FIREWALL_DRY_RUN").as_deref() == Ok("1");
    ...
    /// Open firewall rules for the given port/proto pairs.
    /// Errors are logged as warnings; startup continues regardless.
    pub fn open(&self, ports: &[(u16, &'static str)]) {
